# R25 P0-4 租户白名单配置/DDL 对账报告（20260923-004233）
...
| 类别 | 数量 |
|---|---|
| tenant.excludes 登记 | 94 |
| Entity @TableName 数 | 67 |
| DB 实际表数 | 157 |
| 🔴 RC-3-A 配置先行（excludes 已登记但 DB 无表） | 1 |
| 🔴 RC-3-B 实体存在但 DB 未建表（致命） | 1 |
| 🟡 RC-3-C Entity 与 excludes 重叠（需复核） | 64 |
...
| 表名 | 处置建议 |
|---|---|
| `cms_content` | 从 excludes 移除 OR 补 DDL |
...
| 表名 | Entity 路径 | 处置建议 |
|---|---|---|
| `my_initiated_task_view` | `ruoyi-modules/ruoyi-ipd/src/main/java/org/ruoyi/ipd/workbench/domain/MyInitiatedTask.java` | DBA apply DDL（参考 docs/script/sql/update/） |
...
| 表名 | Entity 路径 | 处置建议 |
|---|---|---|
| `ai_doc_embeddings` | `ruoyi-modules/ruoyi-ipd/src/main/java/org/ruoyi/ipd/domain/AiDocEmbedding.java` | 确认是否租户共享，excludes 登记是预期 |
...
| `correction_logs` | `ruoyi-modules/ruoyi-ipd/src/main/java/org/ruoyi/ipd/domain/CorrectionLog.java` | 确认是否租户共享，excludes 登记是预期 |
...
| `handover_records` | `ruoyi-modules/ruoyi-ipd/src/main/java/org/ruoyi/ipd/domain/HandoverRecord.java` | 确认是否租户共享，excludes 登记是预期 |
| `hr_organizations` | `ruoyi-modules/ruoyi-ipd/src/main/java/org/ruoyi/ipd/domain/HrOrganization.java` | 确认是否租户共享，excludes 登记是预期 |
...
| `kpi_functional_metrics` | `ruoyi-modules/ruoyi-ipd/src/main/java/org/ruoyi/ipd/domain/KpiFunctionalMetric.java` | 确认是否租户共享，excludes 登记是预期 |
| `kpi_raw_records` | `ruoyi-modules/ruoyi-ipd/src/main/java/org/ruoyi/ipd/domain/KpiRawRecord.java` | 确认是否租户共享，excludes 登记是预期 |
| `kpi_records` | `ruoyi-modules/ruoyi-ipd/src/main/java/org/ruoyi/ipd/domain/KpiRecord.java` | 确认是否租户共享，excludes 登记是预期 |
| `kpi_rule_snapshots` | `ruoyi-modules/ruoyi-ipd/src/main/java/org/ruoyi/ipd/domain/KpiRuleSnapshot.java` | 确认是否租户共享，excludes 登记是预期 |
| `kpi_shared_confirms` | `ruoyi-modules/ruoyi-ipd/src/main/java/org/ruoyi/ipd/domain/KpiSharedConfirm.java` | 确认是否租户共享，excludes 登记是预期 |
| `landed_scenarios` | `ruoyi-modules/ruoyi-ipd/src/main/java/org/ruoyi/ipd/domain/LandedScenario.java` | 确认是否租户共享，excludes 登记是预期 |
...
| `person_sync_jobs` | `ruoyi-modules/ruoyi-ipd/src/main/java/org/ruoyi/ipd/domain/PersonSyncJob.java` | 确认是否租户共享，excludes 登记是预期 |
| `persons` | `ruoyi-modules/ruoyi-ipd/src/main/java/org/ruoyi/ipd/domain/Person.java` | 确认是否租户共享，excludes 登记是预期 |
| `post_launch_reviews` | `ruoyi-modules/ruoyi-ipd/src/main/java/org/ruoyi/ipd/domain/PostLaunchReview.java` | 确认是否租户共享，excludes 登记是预期 |
...
| `receipt_ledgers` | `ruoyi-modules/ruoyi-ipd/src/main/java/org/ruoyi/ipd/domain/ReceiptLedger.java` | 确认是否租户共享，excludes 登记是预期 |
| `recovery_warnings` | `ruoyi-modules/ruoyi-ipd/src/main/java/org/ruoyi/ipd/domain/RecoveryWarning.java` | 确认是否租户共享，excludes 登记是预期 |
...
| `requirement_pools` | `ruoyi-modules/ruoyi-ipd/src/main/java/org/ruoyi/ipd/domain/RequirementPool.java` | 确认是否租户共享，excludes 登记是预期 |
| `requirements` | `ruoyi-modules/ruoyi-ipd/src/main/java/org/ruoyi/ipd/domain/Requirement.java` | 确认是否租户共享，excludes 登记是预期 |
| `sop_template_instances` | `ruoyi-modules/ruoyi-ipd/src/main/java/org/ruoyi/ipd/domain/SopTemplateInstance.java` | 确认是否租户共享，excludes 登记是预期 |
...
| `switching_acceptances` | `ruoyi-modules/ruoyi-ipd/src/main/java/org/ruoyi/ipd/domain/SwitchingAcceptance.java` | 确认是否租户共享，excludes 登记是预期 |
| `sys_oss` | `ruoyi-modules/ruoyi-ipd/src/main/java/org/ruoyi/ipd/domain/OssFileEntity.java` | 确认是否租户共享，excludes 登记是预期 |
