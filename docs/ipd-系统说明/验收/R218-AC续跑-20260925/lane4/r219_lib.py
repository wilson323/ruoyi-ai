#!/usr/bin/env python3
# R219 AC续跑 L4 车道执行器公共库（源自 r218_lib.py，REC_PATH 改指本车道）（凭证不落输出；SQL 经 defaults-extra-file）
...
MYSQL = "mysql"
B39 = "http://127.0.0.1:16039"   # R219续跑波次指定实例（fresh jar，本车道唯一目标）
# B46 = "http://127.0.0.1:16046"  # 旧实例，禁用
...
REC_PATH = REPO + "/docs/ipd-系统说明/验收/R218-AC续跑-20260925/lane4/执行清单-lane4.json"
