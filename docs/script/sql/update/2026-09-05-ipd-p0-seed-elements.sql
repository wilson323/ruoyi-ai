...
INSERT IGNORE INTO gate_review_elements (id, gate_code, element_code, element_name, pass_standard, is_veto, sort_order, enabled, create_by, create_time, tenant_id, del_flag)
...
INSERT IGNORE INTO cert_templates (id, country_code, country_name, cert_name, cert_authority, requirement_desc, is_mandatory, create_by, create_time, tenant_id, del_flag)
