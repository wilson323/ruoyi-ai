...
INSERT IGNORE INTO product_groups (id, group_name, leader_person_id, description, create_time, tenant_id, del_flag)
...
INSERT IGNORE INTO persons (id, name, employee_no, person_type, group_id, level, level_source, account_status, employment_status, username, password_hash, must_change_pwd, remark, create_time, tenant_id, del_flag)
...
INSERT IGNORE INTO products (id, product_code, product_name, source, group_id, status, remark, create_time, tenant_id, del_flag)
...
INSERT IGNORE INTO projects (id, code, name, product_id, template_type, level, target_sales_amount, current_stage, lifecycle_status, source, status, main_group_id, launch_date, create_time, tenant_id, del_flag)
...
INSERT IGNORE INTO projects (id, code, name, product_id, template_type, level, target_sales_amount, current_stage, source, status, main_group_id, create_time, tenant_id, del_flag)
...
INSERT IGNORE INTO project_members (id, project_id, person_id, role, member_type, join_date, locked_level, locked_amount, bonus_eligible, create_time, tenant_id, del_flag)
...
INSERT IGNORE INTO project_stages (id, project_id, stage_code, stage_name, sort_order, status, create_time, tenant_id, del_flag)
...
INSERT IGNORE INTO stage_actions (id, project_id, stage_id, action_code, action_name, owner_role, depth, status, is_blocking, actual_done_at, create_time, tenant_id, del_flag)
...
INSERT IGNORE INTO stage_actions (id, project_id, stage_id, action_code, action_name, owner_role, depth, status, is_blocking, due_date, actual_done_at, create_time, tenant_id, del_flag)
